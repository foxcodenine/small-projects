...
if __name__ == '__main__':
    ...
    sell_qty    = Fxt_Settings('sell_qty', '3000') 
    buy_qty     = Fxt_Settings('buy_qty',  '3000') 

    sma_window  = Fxt_Settings('sma_window', '36' , 'Default Value 36')
    ema_window  = Fxt_Settings('ema_window', '288', 'Default Value 144') 
    ...
    sell_target     = Fxt_Settings('sell_target', '1.025',     'Default 1.35 => +35%     Price over buy_price')
    ...
    msl_on   = Fxt_Settings('msl_on',  '0',    'Default 1 => True')
    msl_per  = Fxt_Settings('msl_per', '0.97', 'Default 0.95 => -5% | less than 1')

    trailing_on   = Fxt_Settings('trailing_on',  '1',    'Default 1 => True')
    trailing_per  = Fxt_Settings('trailing_per', '0.995', 'Default 0.98 => -2% | less than 1')    
