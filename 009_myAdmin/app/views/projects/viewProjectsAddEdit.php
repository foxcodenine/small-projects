...
<form action="" class="project-form__form" autocomplete="off" method="POST">
    ...
    <div class="field__group">
        ...
        <input type="text" class="field__input" id="project name" name="projectname">
    </div>

    <div class="field__group">
        <label class="field__label" for="locality">locality</label>
        <div class="field__error"><?= $errorLocalityName; ?></div>
        <input type="text" class="field__input" id="locality" list="locationList" name="localityName">
    ...
    <div class="field__group">
        ...
        <input type="text" class="field__input" id="street address" name="strAddr">
    </div>
    ...
    <div class="field__group">
        ...
        <select  class="field__input field__input--select" id="client" name="clientId">
            ...
            <option value="<?=  $obj->id ?>">  <?=   $obj->id . ' - ' . $obj->firstname . ' ' . $obj->lastname  ?></option>
            <?php endforeach; ?>
        </select>
        <svg class="field__down-arrow">
            <use  xlink:href="./app/static/svg/icomoon.svg#icon-arrow_drop_down"></use>
    ...
    <div class="field__group">
        ...
        <input type="text" class="field__input" id="project no" name="projectNo">
    </div>

    <div class="field__group">
        <label class="field__label" for="pa no">pa no</label>
        <div class="field__error"><?= $errorPaNo; ?></div>
        <input type="text" class="field__input" id="pa no" name="paNo">
    </div>

    <div class="field__group">
        <label class="field__label" for="stage">stage</label>
        <div class="field__error"><?= $errorStageName; ?></div>
        <input type="text" class="field__input" id="stage" list="stageList" name="stageName">
    ...
    <div class="field__group">
        ...
        <input type="text" class="field__input" id="category" list="categoryList" name="categoryName">
    ...
    <div class="field__group">
        ...
        <input type="text" class="field__input dateFormat" id="date" name="projectDate">
    </div>
    ...
    <div class="field__group field__group--textarea">
        ...
        <textarea id="editor_body" class="ck" name="description"></textarea>
    </div>    
